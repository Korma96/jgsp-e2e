...
public class ShowAdminsTab {
    ...
    public void ensureIsAdminsSuccessLoaded() {
        new WebDriverWait(driver, 10)
        .until(ExpectedConditions.textToBePresentInElement(toastr, "Admins are successfully loaded!"));
    }
